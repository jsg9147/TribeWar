...
public class SingleCardManager : MonoBehaviour
{
    ...
    //            tutorial_index = 0;
    //        Card card = DataManager.instance.Tutorial_Card(tutorial_index);
    //        tutorial_index++;
    //        return card;
    //    }
    ...
    //{
    //    List<string> deckItem = new List<string>();

    //    if (isTutorial == false)
    //    {
    //        deckItem = DataManager.instance.Select_Deck.cards;
    //    }
    //    else
    //    {
    //        foreach (var card in DataManager.instance.GetCardDataList())
    //        {
    //            deckItem.Add(card.id);
    //            deckItem.Add(card.id);
    //        }
    //    }
    //    itemBuffer = new List<Card>();
    //    foreach (var card_id in deckItem)
    //    {
    ...
    //    if (card_id == null || SingleEntityManager.instance.SelectMonsterMode) { return; }
